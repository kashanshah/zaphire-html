...
<main id="container" class="scroll-wrapper">
    ...
    <section class="icons-section">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="info-box info-box-v1 animate" data-animation="fadeIn" data-duration="250">
                ...
                <div class="col-md-4">
                    <div class="info-box info-box-v2 animate" data-animation="fadeIn" data-duration="250">
                ...
                <div class="col-md-4">
                    <div class="info-box info-box-v3 animate" data-animation="fadeIn" data-duration="250">
        ...
        <div class="container position-relative">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 offset-md-1">
                    <h2 class="animate" data-animation="fadeIn" data-duration="250">Make Real Connections</h2>
                    <p class="animate" data-animation="fadeIn" data-duration="250">Lorem ipsum dolor sit amet,<br class="d-none d-md-block"/> consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
        </div>
    </section>
    <section class="content-sec dotted-bg uppdots-sec">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    <h2 class="animate" data-animation="fadeIn" data-duration="250">Immersive experience of hiring real people</h2>
                    <p class="animate" data-animation="fadeIn" data-duration="250">Lorem ipsum dolor sit amet,<br class="d-none d-md-block"/> consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
        </div>
    ...
    <section class="content-sec dotted-bg downdots-sec">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <h2 class="animate" data-animation="fadeIn" data-duration="250">Believe the new Change</h2>
                    <p class="animate" data-animation="fadeIn" data-duration="250">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="tab-sec">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="mb-5 text-center animate" data-animation="fadeIn" data-duration="250">Simplifying human <br class="d-none d-lg-block">expression in real-time</h1>
                    <div class="tab-mn">
                        <div class="tab-head animate" data-animation="fadeIn" data-duration="250">
                            <ul>
                        ...
                        <div class="tab-content animate" data-animation="fadeIn" data-duration="250">
                            <div class="row">
    ...
    <section class="box-sec text-center mb-5">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="box animate" data-animation="fadeIn" data-duration="250">
	...
	<section class="content-sec">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <h2 class="animate" data-animation="fadeIn" data-duration="250">Reach</h2>
                    <p class="animate" data-animation="fadeIn" data-duration="250">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
        </div>
    ...
    <section class="content-sec">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 order-md-0 text-md-right animate" data-animation="fadeIn" data-duration="250">
                    <img src="assets/images/img-5.png" alt="" class="img-fluid">
                </div>
                <div class="col-md-6">
                    <h2 class="animate" data-animation="fadeIn" data-duration="250">Co-host</h2>
                    <p class="animate" data-animation="fadeIn" data-duration="250">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
        </div>
    ...
    <section class="content-sec">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <h2 class="animate" data-animation="fadeIn" data-duration="250">Stream</h2>
                    <p class="animate" data-animation="fadeIn" data-duration="250">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
        </div>
    ...
    <section class="content-sec">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 order-md-0 text-md-right animate" data-animation="fadeIn" data-duration="250"><img src="assets/images/img-5.png" alt="" class="img-fluid"></div>
                <div class="col-md-6">
                    <h2 class="animate" data-animation="fadeIn" data-duration="250">Translate</h2>
                    <p class="animate" data-animation="fadeIn" data-duration="250">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
        </div>
    ...
    <section class="content-sec">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 order-md-1 animate" data-animation="fadeIn" data-duration="250"><img src="assets/images/img-7.png" alt="" class="img-fluid"></div>
                <div class="col-md-6">
                    <h2 class="animate" data-animation="fadeIn" data-duration="250">Ever live</h2>
                    <p class="animate" data-animation="fadeIn" data-duration="250">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
        </div>
    ...
    <section class="cta-sec">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center animate" data-animation="fadeIn" data-duration="250">
                    <div class="cta-mn">
                        <h2 class=" animate" data-animation="fadeIn" data-duration="250">Lorem ipsum dolor sit amet, consectetur adipiscing</h2>
                    </div>
                    <a href="#" class="btn btn-primary animate" data-animation="fadeIn" data-duration="250"><span>Sign Up for Pilot Now</span></a>
                </div>
            </div>
        </div>
    </section>
