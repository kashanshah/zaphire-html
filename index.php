...
<main id="container" class="scroll-wrapper">
    ...
    <section class="icons-section">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="info-box info-box-v1 animate" data-animation="fadeIn" data-duration="5">
                ...
                <div class="col-md-4">
                    <div class="info-box info-box-v2 animate" data-animation="fadeIn" data-duration="5">
                ...
                <div class="col-md-4">
                    <div class="info-box info-box-v3 animate" data-animation="fadeIn" data-duration="5">
    ...
    <section class="content-sec dotted-bg">
        <div class="container position-relative">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 md-order-2 animate" data-animation="fadeIn" data-duration="5">
